...
//		result += postRegisterAPI.getEntitystr();
		...
		postOrderBuildAPI.setHost("http://test-api.mishi.cn/gw/mishi.order.build/1.0");
		...
		postOrderBuildRequestObject.setDateType(2);
		postOrderBuildRequestObject.setIsSimple(false);
		postOrderBuildRequestObject.setShopId("28823");
		postOrderBuildRequestObject.setProductBiz(2);
		Goods buildGoods = new  Goods();
		buildGoods.setName("审核后添加");
		buildGoods.setCount(1);
		buildGoods.setGoodsId("53924");
		buildGoods.setPrice(1);
